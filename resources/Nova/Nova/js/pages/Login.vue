<template>
  <div>
    ...
    >
      ...
      <a
    class="mt-3 border text-left appearance-none cursor-pointer rounded text-sm font-bold focus:outline-none focus:ring ring-primary-200 dark:ring-gray-600 relative disabled:cursor-not-allowed inline-flex items-center justify-center shadow h-9 px-3 bg-primary-500 border-primary-500 hover:[&:not(:disabled)]:bg-primary-400 hover:[&:not(:disabled)]:border-primary-400 text-white dark:text-gray-900 w-full flex justify-center"
    href="/nova/cas-login"
    >
    <div class="flex items-center">

    <div class="w-8 h-8" style="background-image: url(https://i0.wp.com/www.cai.mo.it/wp-content/uploads/2016/09/Logo-CAI-trasparente.png); background-size: contain; background-repeat: no-repeat; align-self: center;">
    </div>
    <span >
    Autenticazione CAI
    </span>
