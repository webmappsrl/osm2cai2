    ...
    */
    ...
    'disks' => [
        ...
        'wmfemitur-region' => [
            ...
            'root' => 'osm2cai/mitur/region',
            'url' => env('AWS_URL'),
        ],
        'wmfemitur-hikingroute' => [
            'driver' => 's3',
            'key' => env('AWS_DUMPS_ACCESS_KEY_ID'),
            'secret' => env('AWS_DUMPS_SECRET_ACCESS_KEY'),
            'region' => env('AWS_DEFAULT_REGION'),
            'bucket' => env('AWS_FE_BUCKET'),
            'root' => 'osm2cai/mitur/hikingroute',
            'url' => env('AWS_URL'),
        ],
        'wmfemitur-poi' => [
            'driver' => 's3',
            ...
            'region' => env('AWS_DEFAULT_REGION'),
            'bucket' => env('AWS_FE_BUCKET'),
            'root' => 'osm2cai/mitur/ecpoi',
            'url' => env('AWS_URL'),
        ],
        'wmfemitur-mountaingroup' => [
            'driver' => 's3',
            'key' => env('AWS_DUMPS_ACCESS_KEY_ID'),
            'secret' => env('AWS_DUMPS_SECRET_ACCESS_KEY'),
            'region' => env('AWS_DEFAULT_REGION'),
            'bucket' => env('AWS_FE_BUCKET'),
            'root' => 'osm2cai/mitur/mountaingroup',
            'url' => env('AWS_URL'),
        ],
        'wmfemitur-caihut' => [
            'driver' => 's3',
