...
Route::get('/geojson/{id}', function ($id) {
    ...
    return response()->json($geojson);
})->name('feature-collection-map.geojson.legacy');

// Route per il widget della mappa (compatibilità con il vecchio formato)
...
})->name('feature-collection-map.widget.legacy');
